		...
		<div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
		  <div class="carousel-inner">
		    <div class="carousel-item active">
		        <img src="${pageContext.request.contextPath}/resources/img/spring.jpg" style="width: 100%; height: 150px;" alt="spring">
		    </div>
		    <div class="carousel-item">
		      <img src="${pageContext.request.contextPath}/resources/img/oracle.png"  style="width: 100%; height: 150px;" alt="oracle">
		    </div>
		  </div>
		</div>
	</div>
